...
The contrast-led opener works best when the current alternative is familiar enough that the audience nods immediately ("yeah, that *is* what learners do today").
...
- **Use the prompt sentence words verbatim when possible.** If your prompt sentence says "freshman," your hook says "freshman" — not "first-year learner." Vocabulary consistency makes the hook feel like the same build as the worksheet.
...
2. **Cut to a smaller user.** "Learners" fails the user-naming test because learners is a class, not a person. "Freshmen who live alone in a dorm and take intro CS" passes. Cut to the smaller user; the hook tightens.
