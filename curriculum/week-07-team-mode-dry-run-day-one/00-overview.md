...
| [resources.md](./01-resources.md) | MLH organizer handbook, Atlassian agile guides, devpost help, GitHub student dev pack tools, public team-charter templates |
| [lecture-notes/01-kickoff-and-roles.md](./02-lecture-notes/01-kickoff-and-roles.md) | The 60-minute kickoff meeting; the three core roles; the role-fit grid; rotation rules |
| [lecture-notes/02-scoping-and-parallelization.md](./02-lecture-notes/02-scoping-and-parallelization.md) | Re-running the Week-5 worksheet as a team; the three-track parallelization model; the hour-by-hour schedule |
| [lecture-notes/03-comms-norms-and-fixing-conflict.md](./02-lecture-notes/03-comms-norms-and-fixing-conflict.md) | One channel, one doc, one stand-up rule; the four day-1 conflicts and the one-sentence interventions |
| [exercises/exercise-01-team-charter-for-fake-event.md](./03-exercises/exercise-01-team-charter-for-fake-event.md) | Draft a `TEAM-CONTRACT.md` for a fake 24-hour event prompt in 45 minutes |
| [exercises/exercise-02-hour-by-hour-schedule.md](./03-exercises/exercise-02-hour-by-hour-schedule.md) | Build a printable hour-by-hour day-1 schedule from a written prompt |
| [exercises/exercise-03-conflict-intervention-drill.md](./03-exercises/exercise-03-conflict-intervention-drill.md) | Write one-sentence interventions for the four named conflicts |
| [challenges/README.md](./04-challenges/00-overview.md) | Index of optional challenges |
| [challenges/challenge-01-clean-24-hours.md](./04-challenges/challenge-01-clean-24-hours.md) | Acceptance criteria for "did the team run a clean 24 hours?" |
| [quiz.md](./05-quiz.md) | 10 multiple-choice questions on team dynamics and time-boxed project management |
| [homework.md](./06-homework.md) | Six practice problems for the week |
| [mini-project/README.md](./07-mini-project/00-overview.md) | The full 24-hour dry-run spec, log template, and acceptance criteria |
