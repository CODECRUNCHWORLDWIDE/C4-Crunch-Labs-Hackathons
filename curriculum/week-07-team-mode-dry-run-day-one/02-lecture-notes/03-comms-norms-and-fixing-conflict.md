...
Continue to the [exercises](../03-exercises/) — three drills that rehearse the lectures in writing before the dry-run weekend. Exercise 1 is the team-charter for a fake event; Exercise 2 is the hour-by-hour schedule for a fake prompt; Exercise 3 is the four-conflict intervention drill.
