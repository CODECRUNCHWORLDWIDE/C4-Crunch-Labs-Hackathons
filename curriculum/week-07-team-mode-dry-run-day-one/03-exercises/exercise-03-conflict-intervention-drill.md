...
- [The quiz](../05-quiz.md) — 10 multiple-choice questions on team dynamics and time-boxed project management.
- [The challenge](../04-challenges/challenge-01-clean-24-hours.md) — the optional acceptance criteria for "did the team run a clean 24 hours?"
- [The homework](../06-homework.md) — six practice problems.
- [The mini-project](../07-mini-project/00-overview.md) — the 24-hour dry-run with real teammates.
