...
If you have time, move on to the optional [Challenge 1 — 12-hour solo build](../04-challenges/challenge-01-12-hour-solo-build.md). Otherwise, head to the [mini-project](../07-mini-project/00-overview.md).
