...
**Hint.** Look at the worked example in [Lecture 2 §8](./02-lecture-notes/02-the-12-hour-rule-and-demo-or-die.md) for shape. Do not copy the example; invent.
...
When you've finished all six, push your repo and finalize the [mini-project](./07-mini-project/00-overview.md) — your personal Hackathon Operating Document.
