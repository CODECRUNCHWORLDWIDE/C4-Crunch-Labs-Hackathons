...
When you have finished all six, push your repo and finalize the [mini-project](./07-mini-project/00-overview.md) — your `hackathon-template` repo, polished into the deliverable for the week.
