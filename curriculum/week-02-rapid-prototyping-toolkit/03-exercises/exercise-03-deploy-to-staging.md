...
- **Challenge 1 (optional)** — [shave 30 minutes off your spin-up](../04-challenges/challenge-01-shave-30-min-off-spinup.md).
- **The mini-project** — [polish your `hackathon-template` repo into the deliverable](../07-mini-project/00-overview.md) that earns the week.
