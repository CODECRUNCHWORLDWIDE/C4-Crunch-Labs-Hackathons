...
```mermaid
flowchart LR
  A["Hour 20 - Dress rehearsal"] --> B["Hour 22 - Submission package"]
  B --> C["Hour 23 - Stop work lock"]
  C --> D["Hour 24 - Retrospective"]
```
*The closing four hours run strictly in sequence - each output gates the next.*
