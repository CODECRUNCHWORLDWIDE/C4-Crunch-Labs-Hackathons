...
**Proposed pivot:**
Sam proposed changing the target user from FIU learners walking from dorms
...
are the three pivot-class changes). FIU learners → Miami bus commuters is
a user change.
...
Sam (Demo Lead) confirms the FIU-learner framing is locked. Demo script
will reference "learners walking to morning classes" without introducing
...
**KEPT (4 items):**
  ...
  - [Alex] The 15-minute pivot cap — Sam's transfer-learner proposal at
