...
The fake build referenced throughout these solutions is `MorningWalk` — a single-page web tool for FIU CS learners that takes the user's dorm and class building and returns a "leave by" timestamp using a hardcoded Google Maps API call. Three MUSTs (form, walk-time estimate, leave-by timestamp); two SHOULDs (saved trips in localStorage, dark-mode toggle); committed in the Week 8 dry-run with a live deploy URL and a 3-minute demo video.
...
**Score:** 3 / 5
**Evidence (one line):** Narrow target (FIU CS learners walking to 8am
...
"Who is this for, exactly? Why did you choose FIU CS learners?"

**30-second answer (written):**

The user is a junior or senior CS learner at FIU who lives in the on-campus
...
Before the build, we surveyed 8 FIU CS learners; 6 of them said they
...
to the specific dorm-to-class-building paths that FIU learners actually
...
"college learners at residential campuses with morning classes" — a
...
If 20 FIU learners actually use this in the first month, we will keep
...
**Fake question:**
"What is the average walking speed of a CS learner at FIU compared to
the national average for college learners?"
...
more weeks, we would survey 30 FIU learners with a phone GPS and
...
learners walking to 8am classes."
...
see 20 FIU learners using this in the first month. Thank you." The
...
I am at the end of the problem beat, naming "FIU CS learners walking
