...
- **Public rubric samples.** MLH organizer guide; NumFOCUS event playbook; Devpost public-event rubrics; GitHub Education's learner-hackathon rubric pattern. The samples are the floor; events customise upward.
...
| [resources.md](./resources.md) | MLH organizer guide, NumFOCUS playbook, Devpost help, public rubrics, public judge memoirs, the GitHub learner dev pack list |
