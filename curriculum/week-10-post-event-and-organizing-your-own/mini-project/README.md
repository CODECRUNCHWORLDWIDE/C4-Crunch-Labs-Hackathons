...
- **Risks.** Under-application. The named *fix*: extend application window by 1 week; increase marketing reach via learner-org cross-promotion.
...
- Names the *funding source* per line item (sponsor cash, university learner-activities fee, organiser-fronted reimbursement, MLH-provided in-kind).
...
- **Three alumni or learner judges** (named humans, named year of graduation, named connection to the event).
...
- [ ] The plan has been read by one human outside the C4 cohort — a faculty advisor, a learner-activities staff member, or a peer organiser — and their feedback notes are in `PLAN.md` under a *reviewer feedback* section.
...
- Earns you a 20-minute meeting with the campus learner-activities office.
...
- The plan has been read by *at least one outside human* (a faculty advisor, a learner-org staff member, a peer organiser) and the feedback notes are in the plan.
