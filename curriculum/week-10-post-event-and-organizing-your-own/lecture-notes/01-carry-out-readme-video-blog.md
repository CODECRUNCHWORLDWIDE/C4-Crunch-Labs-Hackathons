...
```mermaid
flowchart TD
  D0["Day 0 - Closing day photos"] --> D1["Day 1 - Verify repo and demo"]
  D1 --> D2["Day 2 - README pass"]
  D2 --> D3["Day 3 - Ninety second phone demo"]
  D3 --> D4["Day 4 - Blog or tweet thread"]
  D4 --> D5["Day 5 - LinkedIn and resume"]
  D5 --> D6["Day 6 - Retro PR"]
  D6 --> D7["Day 7 - Thank yous and close out"]
```
*The seven-day carry-out window — one named artifact per afternoon.*
...
- **Beat 1 — Problem (15 seconds).** Speaker faces camera. One sentence on the user pain. One sentence on the moment. No tech, no team intro, no "for HackXYZ we built." Example: *"Campus learners wait 14 days for emergency tuition decisions. We built a tool that decides in 48 hours."*
...
```mermaid
flowchart LR
  B1["Beat 1 - Problem - 15s"] --> B2["Beat 2 - Demo - 50s"]
  B2 --> B3["Beat 3 - Stack - 15s"]
  B3 --> B4["Beat 4 - Ask - 10s"]
```
*The four-beat arc of the 90-second recruiter-facing phone demo.*
