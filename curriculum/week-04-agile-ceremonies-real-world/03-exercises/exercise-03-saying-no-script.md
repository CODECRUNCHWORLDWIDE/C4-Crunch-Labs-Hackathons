...
Saturday: draft the [mini-project — team contract template](../07-mini-project/00-overview.md). The three exercises feed into the contract: the stand-up format becomes contract section 2, the pointing scale becomes section 6, the "no" script becomes section 7. The contract is the artifact that holds all three.
